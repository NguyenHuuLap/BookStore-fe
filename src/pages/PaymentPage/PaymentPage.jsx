...
const PaymentPage = () => {
  ...
  const discountMemo = location.state?.discount || 0;

  const totalPriceMemo = useMemo(() => {
    return Number(priceMemo) + Number(diliveryPriceMemo) - Number(discountMemo);
  }, [priceMemo, diliveryPriceMemo, discountMemo]);
